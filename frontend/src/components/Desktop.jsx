    ...
    return {
      ...
      fileSystem: {
        ...
        files: [
          ...
          { name: 'readme.txt', type: 'file', content: 'Welcome to CogniFlight!' },
          { name: 'notes.txt', type: 'file', content: 'Operational notes...' }
        ]
      },
      pinnedToTaskbar: savedPinnedTaskbar ? JSON.parse(savedPinnedTaskbar) : defaultTaskbarApps,
      pinnedToDesktop: savedPinnedDesktop ? JSON.parse(savedPinnedDesktop) : defaultDesktopApps,
      clipboard: '',
      notifications: []
    }
  }, [])
